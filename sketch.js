...
function setup() 
{
  ...
  portal = createSprite(2596, -396, 150, 300);
}
...
function draw() 
{
  ...
  if(gameState === "start")
  {
    ...
    textSize(20);
    text("Survive on the island with zombies and ghosts following you. Try to find the portal and reach it.", displayWidth/7, displayHeight/3);
    ...
    text("The player is lost, first find it and then start", displayWidth/4, displayHeight/2.3)
